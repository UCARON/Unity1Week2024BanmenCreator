    ...
    sections: [
        {
            title: "基本操作",
            content: [
                "左側のパレットからアイテムを選択し、グリッド上のマスをクリックして配置できます。",
                "各アイテムの配置方法:",
                "- 空白マス(0番): 何も置かない状態に戻します",
                "- 柵(1番): 固定壁として機能します",
                "- ロケット(2番): プレイヤーのスタート位置です",
                "- アイテム(3番): 収集するアイテムとして機能します",
                "- ボム(4番): 爆弾アイテムとして機能します",
                "- ワンテッド(5番): ワンテッドポスターとして機能します",
                "- キー(6番): ドアを開けるための鍵として機能します",
                "- ドア(7番): ゴールとなるドアです"
            ]
        },
        {
